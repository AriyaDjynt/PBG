...
public class Register extends Activity
{
    ...
    Button daftar;
    private static String url = "http://192.168.1.100/login/register.php";
    ...
    public class daftarAku extends AsyncTask < String, String, String > {
        ...
        {
            @SuppressLint("WrongThread") String strnama = nama.getText().toString();
            @SuppressLint("WrongThread")String stremail = email.getText().toString();
            @SuppressLint("WrongThread")String strpassword = password.getText().toString();
    ...
    public class EmailValidator
    {
        ...
        private static final String EMAIL_PATTERN = "^[_A-Za-z0-9-] + (\\. [_A - Za - z0 - 9 - ] + ) * @[A - Za - z0 - 9] + (\\. [A - Za - z0 - 9] + ) * (\\. [A - Zaz] {2,}) $ ";
